...
pub const ERR_MESS_FOPEN: &str = "Unable to open file";
pub const ERR_MESS_FWRITE: &str = "Unable to write data";
// Console messages
pub const MESS_INTRO: &str = "**************** Expense Tracker in Rust ******************";
pub const MESS_INTRO_2: &str = "Do you want to record expense or income?";
pub const MESS_OPT_CHOOSE: &str = "0 -> Expense / 1 -> Income / 3 -> Exit : ";
pub const MESS_ENTER_AMT: &str = "Enter amount: ";
